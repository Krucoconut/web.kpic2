...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    ...
    <main class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-wide">ฝ่ายบริหารทรัพยากร</h2>
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-wide">(งานทะเบียน)</h2>
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden w-full max-w-sm border border-gray-100 text-center">
                <div class="bg-gradient-to-b from-blue-50 to-white pt-8 pb-4">
                    <div class="w-44 h-44 mx-auto rounded-full overflow-hidden border-4 border-[#002d4a] shadow-md">
                        <img src="images/sv.png" alt="ผู้อำนวยการ" class="w-full h-full object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-1">ว่าที่ร้อยตรีสุวิญ นิ่มนาง</h3>
                    <p class="text-blue-600 font-semibold text-sm tracking-wide mb-2">รองผู้อำนวยการฝ่ายบริหารทรัพยากร</p>
                    <p class="text-gray-500 text-xs">(รักษาการในตำแหน่ง รองผู้อำนวยการฝ่ายวิชาการ)</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                <div class="w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 mb-5">
                    <img src="images/t-tawesak.png" alt="นายทวีศักดิ์ บุญธรรม" class="w-full h-auto block object-cover">
                </div>
                <div class="w-full">
                    <h4 class="text-xl font-bold text-gray-900 mb-2">นายทวีศักดิ์ บุญธรรม</h4>
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> หัวหน้างานทะเบียน </p>
            ...
            <div class="w-full lg:w-2/3 flex flex-col justify-between">
                <div>
                    <h3 class="text-xl md:text-1xl font-bold text-gray-900 pb-4 mb-6 border-b-2 border-gray-200 flex items-center gap-2">
                        <i class="fas fa-tasks text-blue-600"></i> หน้าที่และความรับผิดชอบ - งานทะเบียน
                    </h3>
                    
                    <ol class="space-y-3.5 text-gray-700 text-sm md:text-base list-none">
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">1.</span><span>จัดหาแบบพิมพ์ต่าง ๆ ที่ใช้ในงานทะเบียน</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">2.</span><span>ดำเนินการเกี่ยวกับการรับสมัครนักเรียน นักศึกษา และการตรวจหลักฐานต่าง ๆ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">3.</span><span>ดำเนินการให้มีการขึ้นทะเบียนเป็นนักเรียน นักศึกษา และผู้เข้ารับการฝึกอบรม</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">4.</span><span>ดำเนินการให้มีการลงทะเบียนรายวิชา ลงทะเบียนภายหลังกำหนด การขอพักการเรียน การขอคืนสภาพการเป็นนักเรียนนักศึกษาและแจ้งให้ผู้เกี่ยวข้องทราบ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">5.</span><span>จัดทำบัตรประจำตัวนักเรียน นักศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">6.</span><span>ตรวจสอบรายชื่อ นักเรียน นักศึกษาที่ไม่มีสิทธิ์สอบ การสอบแก้ตัว การสอบทดแทน การพ้นสภาพการเป็นนักเรียน นักศึกษา เพื่อนำเสนอให้ผู้อำนวยการวิทยาลัยทราบและพิจารณาและ/หรือผู้ที่เกี่ยวข้องทราบตามควรแก่กรณี</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">7.</span><span>ประสานกับงานวัดผลและประเมินผล จัดทำรายงานผลการเรียนเฉลี่ย(GPA) และตำแหน่งเปอร์เซ็นต์ไทล์ (PR) เสนอหน่วยงานที่เกี่ยวข้อง</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">8.</span><span>รับผลการประเมินผลการเรียนประจำภาค ซึ่งผู้อำนวยการวิทยาลัยอนุมัติแล้วบันทึกลงในระเบียบแสดงผลการเรียน</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">9.</span><span>ให้บริการเกี่ยวกับการออกหลักฐานทางการเรียน เช่น การออกสำเนาระเบียนแสดงผลการเรียน ใบรับรองผลการเรียน ประกาศนียบัตร และเอกสารอื่น ๆ ที่เกี่ยวข้อง</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">10.</span><span>รับและดำเนินการเกี่ยวกับคำร้องต่าง ๆ ของนักเรียน นักศึกษาที่เกี่ยวข้องกับ งานทะเบียน เช่น การลาออก    การพักการเรียน การโอน ย้าย การเรียนภาคฤดูร้อน การขอเปลี่ยนชื่อ ชื่อสกุล วันเดือนปีเกิด เป็นต้น</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">11.</span><span>ส่งแบบสำรวจและรายงานต่าง ๆ ที่เกี่ยวข้องกับงานทะเบียน รวมทั้ง รายงานการเรียนของผู้สำเร็จการศึกษาให้หน่วยงานและผู้เกี่ยวข้องตามระเบียบ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">12.</span><span>จัดระบบการเก็บรักษาเอกสารและหลักฐานการลงทะเบียนและเอกสารอื่น ๆ ตามความจำเป็นที่เกี่ยวกับงานทะเบียนให้เป็นไปตามระเบียบ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">13.</span><span>เก็บรักษาเอกสารและหลักฐานต่าง ๆ ไว้เพื่อการตรวจสอบและดำเนินการทำลายเอกสารตามระเบียบ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">14.</span><span>ประสานงานและให้ความร่วมมือกับหน่วยงานต่าง ๆ ทั้งภายในและภายนอกสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">15.</span><span>จัดทำปฏิทินการปฏิบัติงาน เสนอโครงการและรายงานการปฏิบัติงานตามลำดับขั้น</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">16.</span><span>ดูแล บำรุงรักษา และรับผิดชอบทรัพย์สินของสถานศึกษาที่ได้รับมอบหมาย</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">17.</span><span>ปฏิบัติงานอื่นตามที่ได้รับมอบหมาย</span></li>
                    </ol>
                </div>
...
<br>
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                <div class="w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 mb-5">
                    <img src="images/t-pon.png" alt="นางสาวกนกพร บาทชารี" class="w-full h-auto block object-cover">
                </div>
                <div class="w-full">
                    <h4 class="text-xl font-bold text-gray-900 mb-2">นางสาวกนกพร บาทชารี</h4>
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> ผู้ช่วยหัวหน้างานทะเบียน </p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>
                </div>
...
<br>
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                <div class="w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 mb-5">
                    <img src="images/user.jpg" alt="นายวุฒินันท์ สุวรรณหงษ์" class="w-full h-auto block object-cover">
                </div>
                <div class="w-full">
                    <h4 class="text-xl font-bold text-gray-900 mb-2">นางสาวนุจรีย์ นุชิต</h4>
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> ผู้ช่วยหัวหน้างานทะเบียน </p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>
...
<br>
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    <h4 class="text-xl font-bold text-gray-900 mb-2">นางสาวพัชรินทร์ กะวิกุล</h4>
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> ผู้ช่วยหัวหน้างานทะเบียน </p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>

...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    ...
    <main class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2 tracking-wide">แผนกวิชายานยนต์ไฟฟ้า</h2>
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden w-full max-w-sm border border-gray-100 text-center">
                <div class="bg-gradient-to-b from-blue-50 to-white pt-8 pb-4">
                    <div class="w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-blue-600 shadow-inner">
                        <img src="images/t-mon.jpg" alt="นายอมรเทพ สุภางาม" class="w-full h-50 object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-1">นายอมรเทพ สุภางาม</h2>
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-patom.png" alt="นายประถม พรมสมบัติ" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นายประถม พรมสมบัติ</h3>
            <div class="mb-4">
                <p class="text-slate-700 font-medium text-sm">พนักงานราชการ (ครู)</p>
                <p class="text-slate-500 text-xs mt-0.5">(แผนกวิชายานยนต์ไฟฟ้า)</p>
            </div>
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-ex.png" alt="นายเกียรติกุล สาขา" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นายเกียรติกุล สาขา</h3>
            <div class="mb-4">

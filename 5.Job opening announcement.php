...
<body class="min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 flex flex-col lg:flex-row justify-between items-center gap-6">
            ...
            <div class="flex flex-wrap items-center gap-6 text-sm">
                <div class="flex items-center gap-2 text-gray-200">
                    ...
                    <span>โทรศัพท์ : <strong class="text-white">042-339744</strong></span>
                </div>
                <div class="flex items-center gap-2 text-gray-200">
    ...
    <div class="bg-white border-b border-gray-200 shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
            ...
            <i class="fas fa-chevron-right text-xs text-gray-400"></i>
            <span class="text-[#002d4a] font-medium">ข่าวรับสมัครงาน</span>
        </div>
    </div>
    ...
    <main class="flex-1 max-w-7xl mx-auto w-full px-6 py-10">
        ...
        <div class="flex items-center gap-3 mb-8">
            ...
            <h1 class="text-3xl font-bold text-[#002d4a]">ข่าวรับสมัครงาน</h1>
        </div>
                ...
                <div class="flex flex-col justify-between p-6 md:p-8 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 leading-relaxed text-base">
                            ตำแหน่งในกลุ่มงานบริหารทั่วไป ค่าตอบแทนรายเดือน จำนวน ๒๑,๗๘๐ บาท </p>
                        <p class="text-gray-600 leading-relaxed text-base">
                            และสิทธิประโยชน์ของพนักงานราชการ ตามระเบียบสำนักนายกรัฐมนตรี ว่าด้วยพนักงานราชการ พ.ศ.๒๕๔๗ </p>
                        <p class="text-gray-600 leading-relaxed text-base">
                            และตามประกาศคณะกรรมการบริหารพนักงานราชการ เรื่อง ค่าตอบแทนพนักงานราชการ พ.ศ.๒๕๖๘</p>

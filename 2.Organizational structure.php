...
<body class="min-h-screen flex flex-col">
    ...
    <div class="bg-white border-b border-gray-200 shadow-sm">
        <div class="max-w-7xl mx-auto px-6 py-3 flex items-center gap-2 text-sm text-gray-500">
            ...
            <i class="fas fa-chevron-right text-xs text-gray-400"></i>
            <span class="text-[#002d4a] font-medium">โครงสร้างองค์กร</span>
        </div>
    </div>

    <img src="images2/vec2.png" alt="โลโก้วิทยาลัยการอาชีพกุมภวาปี" class="w-full h-full object-contain flex-shrink-0">

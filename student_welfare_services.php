...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    ...
    <main class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-wide">(งานสวัสดิการนักเรียน นักศึกษา)</h2>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    ...
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> หัวหน้างานสวัสดิการนักเรียน นักศึกษา</p>
            ...
            <div class="w-full lg:w-2/3 flex flex-col justify-between">
                <div>
                    <h3 class="text-xl md:text-1xl font-bold text-gray-900 pb-4 mb-6 border-b-2 border-gray-200 flex items-center gap-2">
                        <i class="fas fa-tasks text-blue-600"></i> หน้าที่และความรับผิดชอบ - งานสวัสดิการนักเรียน นักศึกษา
                    </h3>
                    
                    <ol class="space-y-3.5 text-gray-700 text-sm md:text-base list-none">
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">1.</span><span>จัดและควบคุมดูแลสวัสดิการและการให้บริการด้านต่าง ๆ ภายใน สถานศึกษา เช่น ร้านอาหาร น้ำดื่ม การทำบัตรประกันสุขภาพ การทำประกันอุบัติเหตุ การทำใบอนุญาตขับขี่ การขอใช้สิทธิลดค่าโดยสารและยานพาหนะต่าง ๆ การตรวจสุขภาพประจำปีและตรวจหาสารเสพติด ของนักเรียน นักศึกษาและผู้เข้ารับการฝึกอบรม</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">2.</span><span>จัดหาเครื่องมือและเวชภัณฑ์ เพื่อปฐมพยาบาลและการให้บริการสุขภาพแก่นักเรียน นักศึกษา และผู้เข้ารับการฝึกอบรม</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">3.</span><span>ดำเนินการเกี่ยวกับการปฐมพยาบาล การบริการทางสุขภาพแก่นักเรียน นักศึกษา ผู้เข้ารับการฝึกอบรม และบุคลากรของสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">4.</span><span>ให้คำปรึกษาและทำหน้าที่เกี่ยวกับสุขภาพอนามัย เผยแพร่ความรู้เกี่ยวกับสุขภาพ สิ่งเสพติดและโรคภัยร้ายแรง   ต่าง ๆ ทั้งการป้องกันและรักษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">5.</span><span>จัดการตรวจติดตามและควบคุมดูแลการเข้าพักทั้งภายในและภายนอกสถานศึกษาให้เป็นไปตามระเบียบ/span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">6.</span><span>จัดโรงอาหาร วางแผน จัดระบบและควบคุมดูแลการประกอบอาหารและการให้บริการแก่นักเรียน นักศึกษา และผู้เข้ารับการฝึกอบรมให้ถูกต้องตามหลักโภชนาการที่ดี</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">7.</span><span>ประสานงานและให้ความร่วมมือกับหน่วยงานต่าง ๆ ที่เกี่ยวข้องทั้งภายในและภายนอกสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">8.</span><span>จัดทำการป้องกันความเสี่ยงของงานสวัสดิการ เช่น การตั้งครรภ์ก่อนวัยอันควร</span></li>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    ...
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> ผู้ช่วยหัวหน้างานสวัสดิการนักเรียน นักศึกษา</p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>
                </div>

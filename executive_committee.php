...
<body class="bg-gray-50 text-gray-800 flex flex-col min-h-screen">
    ...
    <div class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-16">
            <h1 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-wide">คณะผู้บริหาร วิทยาลัยการอาชีพกุมภวาปี</h1>
            <div class="h-1 w-34 bg-blue-600 mx-auto rounded-full"></div>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden w-full max-w-sm border border-gray-100 text-center">
                <div class="bg-gradient-to-b from-blue-50 to-white pt-8 pb-4">
                    <div class="w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-blue-600 shadow-inner">
                        <img src="images/vc.png" alt="ผู้อำนวยการ" class="w-full h-full object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h2 class="text-xl font-bold text-gray-900 mb-1">นายวิชิต ธรรมฤทธิ์</h2>
                    <p class="text-blue-600 font-medium text-sm tracking-wider uppercase mb-3">ผู้อำนวยการ วิทยาลัยการอาชีพกุมภวาปี</p>
                    <p class="text-gray-500 text-xs border-t pt-3">อีเมล: wichit.t@vec.go.th</p>
                </div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
                <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
                    <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                        <img src="images/sv.png" alt="รองผู้อำนวยการฝ่ายบริหารทรัพยากร" class="w-full h-full object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-slate-900 mb-1">ว่าที่ร้อยตรีสุวิญ นิ่มนาง</h3>
                    <div class="mb-4">
                        <p class="text-slate-700 font-medium text-sm">รองผู้อำนวยการฝ่ายบริหารทรัพยากร</p>
                        <p class="text-slate-500 text-xs mt-0.5">(รักษาการในตำแหน่ง รองผู้อำนวยการฝ่ายวิชาการ)</p>
                    </div>
                    <div class="border-t border-slate-100 pt-3 text-slate-400 text-xs">
                        <p>ติดต่อ: 042-xxx-xxx</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
                <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
                    <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                        <img src="images/pt.png" alt="รองผู้อำนวยการฝ่ายกิจการนักเรียน นักศึกษา" class="w-full h-full object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h3 class="text-xl font-bold text-slate-900 mb-1">นางภัทรภร แก้วศิริ</h3>
                    <div class="mb-4">
                        <p class="text-slate-700 font-medium text-sm">รองผู้อำนวยการฝ่ายกิจการนักเรียน นักศึกษา</p>
                        <p class="text-slate-500 text-xs mt-0.5">(รักษาการในตำแหน่ง รองผู้อำนวยการฝ่ายแผนงานและความร่วมมือ)</p>
                    </div>
                    <div class="border-t border-slate-100 pt-3 text-slate-400 text-xs">
                        <p>ติดต่อ: 042-xxx-xxx</p>
                    </div>

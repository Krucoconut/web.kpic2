...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    ...
    <main class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-12">
            ...
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-4 tracking-wide">(งานบริหารงานทั่วไป)</h2>
        ...
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    ...
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> หัวหน้างานบริหารงานทั่วไป </p>
            ...
            <div class="w-full lg:w-2/3 flex flex-col justify-between">
                <div>
                    <h3 class="text-xl md:text-1xl font-bold text-gray-900 pb-4 mb-6 border-b-2 border-gray-200 flex items-center gap-2">
                        <i class="fas fa-tasks text-blue-600"></i> หน้าที่และความรับผิดชอบ - หัวหน้างานบริหารงานทั่วไป
                    </h3>
                    
                    <ol class="space-y-3.5 text-gray-700 text-sm md:text-base list-none">
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">1.</span><span>ปฏิบัติงานตามระเบียบสำนักนายกรัฐมนตรีว่าด้วยงานสารบรรณ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">2.</span><span>จัดทำร่าง หนังสือราชการ ประกาศ คำสั่ง ตรวจสอบความถูกต้องของเอกสาร จัดลำดับความสำคัญของเอกสาร ร่วมมือประสานงานให้ความสะดวกแก่บุคลากรและหน่วยงานในสถานศึกษาเกี่ยวกับงานเอกสารการพิมพ์  ควบคุมดูแลการปฏิบัติงานของเจ้าหน้าที่เอกสารการพิมพ์ให้เป็นไปตามระเบียบแบบแผนของทางราชการ</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">3.</span><span>สรุปความเห็นเสนอผู้บังคับบัญชา และจัดส่งให้แก่หน่วยงานที่เกี่ยวข้องทั้งภายใน และภายนอกสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">4.</span><span>เก็บรวบรวม และจัดระบบเอกสาร หลักฐานและระเบียบวิธีปฏิบัติต่าง ๆ เพื่ออำนวยความสะดวกในการศึกษา และให้บริการแก่บุคลากร และนักเรียนนักศึกษาของสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">5.</span><span>รวบรวมและเผยแพร่ข่าวสาร นโยบาย ระเบียบ ข้อบังคับ คำสั่ง คำชี้แจงประกาศ ให้บุคลากร และนักเรียนนักศึกษา ของสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">6.</span><span>ให้บริการเกี่ยวกับการรับส่งไปรษณีย์ ธนาณัติ โทรสารของบุคลากรนักเรียนและนักศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">7.</span><span>รวบรวมผลงานรางวัลของสถานศึกษา</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">8.</span><span>จัดประชุมคณะกรรมการวิทยาลัย</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">9.</span><span>จัดทำปฏิทินการปฏิบัติงาน เสนอโครงการและรายงานการปฏิบัติงานตามลำดับขั้น</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">10.</span><span>ดูแล บำรุงรักษา และรับผิดชอบทรัพย์สินของสถานศึกษาที่ได้รับมอบหมาย</span></li>
                        <li class="flex items-start gap-2.5"><span class="font-bold text-gray-500 min-w-[24px]">11.</span><span>ปฏิบัติงานอื่นตามที่ได้รับมอบหมาย</span></li>
                    </ol>
                </div>
...
<br>
        <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                <div class="w-full rounded-2xl overflow-hidden shadow-md border border-gray-100 mb-5">
                    <img src="images/t-tuw.png" alt="นางสุรางค์รัตน์ วงษ์ป้อม" class="w-full h-auto block object-cover">
                </div>
                <div class="w-full">
                    <h4 class="text-xl font-bold text-gray-900 mb-2">นางสุรางค์รัตน์ วงษ์ป้อม</h4>
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> ผู้ช่วยหัวหน้างานบริหารงานทั่วไป </p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>
                </div>
       ...
       <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-6 md:p-10 flex flex-col lg:flex-row gap-10 items-stretch content-thai">
            ...
            <div class="w-full lg:w-1/3 max-w-xs mx-auto flex flex-col items-center text-center">
                ...
                <div class="w-full">
                    ...
                    <p class="text-sm text-gray-600 mb-1"><span class="font-bold text-gray-800">ตำแหน่ง:</span> เจ้าหน้าที่งานบริหารงานทั่วไป </p>
                    <p class="text-sm font-semibold text-[#002d4a] mt-2 bg-blue-50 py-1.5 px-3 rounded-lg inline-block">
                        <i class="fas fa-envelope mr-1 text-pink-500"></i> Email : admin@kvc.ac.th
                    </p>
                </div>

...
<body class="bg-gray-100 min-h-screen flex flex-col justify-between">
    ...
    <main class="container mx-auto px-4 py-12 max-w-7xl flex-grow">
        ...
        <div class="text-center mb-16">
            <h2 class="text-3xl md:text-4xl font-bold text-gray-900 mb-2 tracking-wide">แผนกวิชาภาษาต่างประเทศธุรกิจบริการ</h2>
            ...
            <div class="bg-white rounded-2xl shadow-md hover:shadow-xl transition-shadow duration-300 overflow-hidden w-full max-w-sm border border-gray-100 text-center">
                <div class="bg-gradient-to-b from-blue-50 to-white pt-8 pb-4">
                    <div class="w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-blue-600 shadow-inner">
                        <img src="images/t-pla.png" alt="นางสาวกศมา ตุงคะสมิต" class="w-full h-50 object-cover">
                    </div>
                </div>
                <div class="p-6">
                    <h2 class="text-2xl font-bold text-gray-900 mb-1">นางสาวกศมา ตุงคะสมิต</h2>
                    <p class="text-blue-600 font-medium text-sm tracking-wider uppercase mb-1">หัวหน้าแผนกวิชาภาษาต่างประเทศธุรกิจบริการ</p>
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-king.png" alt="นายชำนาญ ผานคำ" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นายชำนาญ ผานคำ</h3>
            <div class="mb-4">
                <p class="text-slate-700 font-medium text-sm">ข้าราชการครูและบุคลากรทางการศึกษา</p>
                <p class="text-slate-500 text-xs mt-0.5">(แผนกวิชาภาษาต่างประเทศธุรกิจบริการ)</p>
            </div>
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-apli.png" alt="นางสาวพราวพิชชา เมิงไชยสงค์" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นางสาวพราวพิชชา เมิงไชยสงค์</h3>
            <div class="mb-4">
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-plum.png" alt="นางสาวภวจันทร์ เจือจันอัด" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นางสาวภวจันทร์ เจือจันอัด</h3>
            <div class="mb-4">
                <p class="text-slate-700 font-medium text-sm">ครูพิเศษสอน</p>
                <p class="text-slate-500 text-xs mt-0.5">(แผนกวิชาภาษาต่างประเทศธุรกิจบริการ)</p>
            </div>
    ...
    <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/t-eath.png" alt="นางสาวอธิฏฐาน สารพัน" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นางสาวอธิฏฐาน สารพัน</h3>
            <div class="mb-4">
                <p class="text-slate-700 font-medium text-sm">ครูพิเศษสอน</p>
                <p class="text-slate-500 text-xs mt-0.5">(แผนกวิชาภาษาต่างประเทศธุรกิจบริการ)</p>
            </div>
     ...
     <div class="w-full md:w-[calc(33.333%-2rem)] max-w-sm bg-white rounded-xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-100 text-center transform hover:-translate-y-1">
        <div class="bg-gradient-to-b from-slate-50 to-white pt-8 pb-3">
            <div class="w-40 h-40 mx-auto rounded-full overflow-hidden border-2 border-slate-200 shadow-sm">
                <img src="images/user.jpg" alt="นางสาวดรัลรัตน์ คำแสนเทียะ" class="w-full h-50 object-cover">
            </div>
        </div>
        <div class="p-6">
            <h3 class="text-xl font-bold text-slate-900 mb-1">นางสาวดรัลรัตน์ คำแสนเทียะ</h3>
            <div class="mb-4">
                <p class="text-slate-700 font-medium text-sm">ครูพิเศษสอน</p>
                <p class="text-slate-500 text-xs mt-0.5">(แผนกวิชาภาษาต่างประเทศธุรกิจบริการ)</p>
            </div>
